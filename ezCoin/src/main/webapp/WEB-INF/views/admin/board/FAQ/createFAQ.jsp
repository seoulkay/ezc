...
function insertFAQBoard() {
	...
	$('#form').attr("action","/admin/board/FAQ/insertFAQPro.do");
	$('#form').submit();
}
 ...
 */
function cancel() {
	$('#form').attr("action","/admin/board/FAQ/manageFAQ.do");
	$('#form').submit();
}
...
<body>
	...
	<jsp:include page="../../common/navbar.jsp"></jsp:include>
			...
			<ol class="breadcrumb pull-right" style="font-size: 12px;">
				  ...
				  <li><a href="/admin/board/FAQ/createFAQ.do">FAQ 등록</a></li>
			</ol>
          <h4 class="sub-header"><span class="glyphicon glyphicon-asterisk"></span> <b>FAQ 등록</b></h4>
          </div>
       
  <form id="form" name="form" action="/admin/board/FAQ/createFAQ.do" method="post">
     <input type="hidden" id="useIs" name="useIs"/>
          ...
          <div class="table-responsive">
						...
						<div class="row pull-right">
								<a href="#" onclick="javascript:insertFAQBoard()" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil"></span> 등록</a>
