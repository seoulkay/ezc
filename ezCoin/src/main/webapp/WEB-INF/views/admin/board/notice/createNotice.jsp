...
function insertNoticeBoard() {
	...
	$('#form').attr("action","/admin/board/notice/insertNoticePro.do");
	$('#form').submit();
}
...
<body>
	...
	<jsp:include page="../../common/navbar.jsp"></jsp:include>
			...
			<ol class="breadcrumb pull-right" style="font-size: 12px;">
				  ...
				  <li><a href="/admin/board/notice/createNotice.do">공지사항 등록</a></li>
			</ol>
          <h4 class="sub-header"><span class="glyphicon glyphicon-asterisk"></span> <b>공지사항 등록</b></h4>
          </div>
       
  <form id="form" name="form" action="/admin/board/notice/createNotice.do" method="post">
