...
function insertPopupBoard() {
	...
	$('#form').attr("action","/admin/board/popup/insertPopupPro.do");
	$('#form').submit();
}
...
<jsp:include page="../../common/navbar.jsp" />
			...
			<ol class="breadcrumb pull-right" style="font-size: 12px;">
				  ...
				  <li><a href="/admin/board/popup/createPopup.do">팝업 생성</a></li>
			</ol>
          <h4 class="sub-header"><span class="glyphicon glyphicon-asterisk"></span> <b>팝업 등록</b></h4>
          </div>
       
  <form id="form" name="form" action="/admin/board/popup/createPopup.do" method="post">
          ...
          <div class="table-responsive">
						<table class="table table-striped">
							...
							<tr>
								<th>시작일</th>
								<td>
								<input type="text" id="startDatePop" name="startDatePop"/>
							...
							<tr>
								<th>종료일</th>
								<td>
								<input type="text" id="endDatePop" name="endDatePop"/>
							...
							<tr>
								<th>당첨자 발표일</th>
								<td>
								<input type="text" id="winDatePop" name="winDatePop"/>
							...
							<tr>
								<th>이벤트 페이지 외부 링크</th>
								<td><input type="text" style="width:100%" name="eventPageExlink"/></td>
							</tr>
							<tr>
								<th>썸네일</th>
								<td><input type="file" name="attatchFile"/></td>
							</tr>
