...
function insertFAQBoard() {
	...
	$('#form').attr("action","/admin/board/FAQ/updateFAQPro.do");
	$('#form').submit();
}
...
<body>
	...
	<div class="container">
	 <jsp:include page="../../common/navbar.jsp" />
          ...
          <h4 class="sub-header"><span class="glyphicon glyphicon-asterisk"></span> <b>FAQ 수정</b></h4>
          </div>
       
  <form id="form" name="form" method="post">
     <input type="hidden" id="useIs" name="useIs"/>
     <input type="hidden" id="FaqMngIdx" name="FaqMngIdx" value="${vo.faqMngIdx}"/>  
